...
if(!empty($_GET['curso'])) {
    ...
    $sqle = "SELECT DISTINCT * FROM alumno_profesor as ap INNER JOIN profesor_materia as pm ON ap.pm_id = pm.pm_id INNER JOIN alumnos as al ON ap.alumno_id = al.
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-sm" title="Ver Notas" href="list-notasex.php?profesor=<?=$data['alumno_id'] ?>&curso=<?= $data['pm_id'] ?>">
