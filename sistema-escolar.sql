...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2021 a las 22:18:48
...
(7, 'Victor Gamarra', 12, 'Venezuela', '20333333', '', 123456789, 'victor@victor.com', '2008-09-20', '2020-11-12', 0),
(8, 'prueba1', 10, 'Venezuela', '13131313', '$2y$10$cFMvx7Vc7mz7cIGU4IUUx.Mo.9LxmVJrhkThVJgB/AFZlCacaEY52', 123456789, 'prueba@prueba.com', '2020-11-13', '2020-11-13', 0),
(9, 'OCTAVIO', 25, 'FGHJK', '151190016', '$2y$10$wnbr2L2RULYfyr8lY/YTgOT11JdB0A1meR0ApP2G0xb/fsT2bKuKG', 67890, 'YUIOLÑ', '2021-05-26', '2021-05-19', 0),
(10, 'octavio', 25, 'mexico', '12345', '$2y$10$PWJropCFuoSf/frWGoH2OufJ9wNrVWs6dTCQXpSlTanzzdIQVp/Vm', 56789, 'oto26g@gmail.com', '2021-05-03', '2021-06-01', 1);
...
(4, 'josemezaaa', 'Venezuelaaaa', '121212', '$2y$10$GV3UKpQ9G7w/3JADV5UxFuYxoQurMFjOhPI3/J6Q3uZXyYIifPqFG', 123456789, 'jose@jose.com', 'Ing de Sistemas', 1),
...
(8, 'maria', 'ghjkl', '7273', '$2y$10$6llz5UiMOa0t5C/KtXB3HeXPknDCNsbVR1jzne4sH805Bcuswa7Pm', 67890, 'ghjklñ', 'ghjk', 1);
...
--
ALTER TABLE `profesor_materia`
  MODIFY `pm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
