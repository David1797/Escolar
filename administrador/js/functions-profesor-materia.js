...
document.addEventListener('DOMContentLoaded',function(){
    ...
    formProfesorMateria.onsubmit = function(e) {
        ...
        var nombre = document.querySelector('#listBProfesor').value;
...
function showBProfesor() {
        ...
        request.onreadystatechange = function() {
            if(request.readyState == 4 && request.status == 200) {
                ...
                document.querySelector('#listBProfesor').innerHTML = data;
            }
        }
}
        ...
        request.onreadystatechange = function() {
            if(request.readyState == 4 && request.status == 200) {
                ...
                if(data.status) {
                    ...
                    document.querySelector('#listBProfesor').value = data.data.profesor_id;
