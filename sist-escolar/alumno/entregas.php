<?php
    ...
    $sqla = "SELECT * FROM ev_entregadas as ev INNER JOIN alumnos as a ON ev.alumno_id = a.alumno_id INNER JOIN evaluaciones as eva ON ev.evaluacion_id = eva.
      ...
      <div class="app-title">
        ...
        <?php if($rowa > 0 ){
          while($data = $querya->fetch()) {
            ...
            $sqln = "SELECT * FROM notas as n INNER JOIN ev_entregadas as ev ON n.ev_entregada_id = ev.ev_entregada_id INNER JOIN alumnos as a ON ev.
            alumno_id = a.alumno_id WHERE n.ev_entregada_id = $ev_entregada AND a.alumno_id = $idAlumno";
               ...
               <div class="tile">
                ...
                <div class="tile-body">
                  <form class="form-horizontal" id="formEntrega" name="formEntrega" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="idalumno" id="idalumno" value="<?= $evaluacion; ?>">  
