...
if(!empty($_GET['curso']) || !empty($_GET['alumno'])) {
    ...
    $sql = "SELECT * FROM notas as n INNER JOIN ev_entregadas as ev_e ON n.ev_entregada_id = ev_e.ev_entregada_id INNER JOIN alumnos as al ON ev_e.alumno_id = 
    al.alumno_id INNER JOIN evaluaciones as ev ON ev_e.evaluacion_id = ev.evaluacion_id INNER JOIN contenidos as c ON ev.contenido_id = c.contenido_id INNER JOIN 
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="bs-component">
                <ul class="list-group">
                    <li class="list-group-item"><span class="tag tag-default tag-pill float-xs-right"><strong>PROMEDIO: <?= formato(promedio($alumno)); ?></
                    strong></span></li>
                </ul>
            </div>    
        </div>
