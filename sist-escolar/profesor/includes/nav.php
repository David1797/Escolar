    ...
    <aside class="app-sidebar">
      ...
      <li><a class="app-menu__item" href="../index.php"><i class="app-menu__icon fas fa-home"></i><span class="app-menu__label">Inicio</span></a>
        ...
        <ul class="treeview-menu">
          ...
          ?>
            <li><a class="treeview-item" href="notas.php?curso=<?=$datam['pm_id'] ?>"><i class="icon fa fa-circle-o"></i><?=$datam
            ['nombre_materia']; ?> - <?= $datam['nombre_grado']; ?> - <?=$datam['nombre_aula']; ?></a></li>    
          <?php } } ?>
        </ul>
        </li>


          <li><a class="app-menu__item" href="../logout.php"><i class="app-menu__icon fas fa-sign-out-alt"></i><span class="app-menu__label">Logout</span></a>
          </li>
      </ul>
    </aside>