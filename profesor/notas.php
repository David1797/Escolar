...
if(!empty($_GET['curso'])) {
    ...
    $sqlc = "SELECT * FROM alumno_profesor as ap INNER JOIN profesor_materia as pm ON ap.pm_id = pm.pm_id INNER JOIN alumnos as al ON ap.alumno_id = al.
                            ...
                            <tbody>
                                    <?php if($rowc > 0){
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-sm" title="Ver Notas" href="list-notas.php?alumno=<?= $data['alumno_id'] ?>&
                                            curso=<?= $data['pm_id'] ?>">
