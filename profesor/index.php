...
<main class="app-content">
      <div class="row">
        <div class="col-md-12 border shadow p-2 bg-info text-white">
          <h3 class="display-4">SISTEMA ESCOLAR - UNEMI</h3>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-4 text-center border mt-3 p-4 bg-light">
            <div class="card m-2 shadow" style="width: 20rem";>
              <img src="images/av.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                ...
                <a href="asistencias.php?curso=<?= $data['pm_id']?>" class="btn btn-secondary">Asistencias</a>
