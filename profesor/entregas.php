...
if(!empty($_GET['curso']) || empty($_GET['contenido']) || empty($_GET['eva'])) {
    ...
    evaluacion_id INNER JOIN contenidos as c ON eva.contenido_id = c.contenido_id WHERE ev.evaluacion_id = ?";
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <div class="input-group">
                                ...
                                <a class="btn btn-primary" href="BASE_URL<?= $data2['material_alumno']; ?>" target="_blank"> Material de Descarga</a>
                              </div>
                        </div>
                        </td>
                        <td><?= $valor ?></td>
