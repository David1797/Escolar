...
if(!empty($_GET['curso'])) {
    ...
    $sql = "SELECT * FROM alumno_profesor as ap INNER JOIN profesor_materia as pm ON ap.pm_id = pm.pm_id INNER JOIN alumnos as a ON ap.alumno_id = a.alumno_id WHERE pm.pm_id = $idProfesor";
                            ...
                            <td>
                                <?php 
                                    if($res_acceso['u_acceso'] == null) {
                                        ...
                                        echo '<kbd class="badge badge-success">ASISTIO</kbd>';
                                    }
